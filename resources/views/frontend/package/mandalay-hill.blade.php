			...
			<div class="col-md-9">
				...
				<div class="row">
					...
					<div class="col-md-12 col-lg-8">
						<div class="card-body">
							<h5 class="card-title font-weight-bold">Day 1:Mandalay</h5>
							<p class="card-text">
								Arrive at mandalay where you will be welcomed by your English speaking local tour guide and transferred to your hotel. After refreshment at hotel, enjoy a walk through downtown mandalay.First,Mandalay_hill,Second,Mahar Myatmuni Pagoda,Third,Royal_palace and so on.
							</p>
						</div>
					</div>
