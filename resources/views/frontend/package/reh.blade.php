...
@section('welcome')
	...
	<div class="container packtitle">
		<h4 class="font-weight-bold">Reh lake Trip</h4>
		<div class="container">
			<div class="row">
			...
			<div class="col-md-9">
				...
				<div class="row">
					...
					<div class="col-md-12 col-lg-8">
						<div class="card-body">
							<h5 class="card-title font-weight-bold">Day 1:Mandalay-Radh</h5>
							<p class="card-text">
								Arrive at mandalay where you will be welcomed by your English speaking local tour guide and transferred to your hotel. After refreshment at hotel, enjoy a walk through downtown mandalay.According to the ancestors of these tribals, the lake was a corridor to their heaven called Pialral. All souls destined to Pialral must pass through the lake.[2] Due to its cultural importance is often referred to as "the largest lake in Mizoram is Rih Dil, which is but in Burma (Myanmar)
							</p>
						</div>
					</div>
