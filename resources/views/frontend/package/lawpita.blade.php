...
<div class="container packtitle">
	<h4 class="font-weight-bold">Lawpita Waterfall Trip</h4>
	<div class="container">
		<div class="row">
	...
	<div class="col-md-9">
		<h4>Detail Itinetary</h4>
			<div class="row">
				...
				<div class="card-body">
					<h5 class="card-title font-weight-bold">Day 1:Mandalay-Kayar
					</h5>
				<p class="card-text">
				Arrive at mandalay where you will be welcomed by your English speaking local tour guide and transferred to your hotel. Pathein formerly called Bassein, is the largest city and the capital of the Ayeyarwady Region, Myanmar (Burma).
				</p>
			</div>
		</div>
...
<div class="row">
	...
	<div class="col-md-12 col-lg-8">
		<div class="card-body">
			<h5 class="card-title font-weight-bold">Day 2:Lawpita Waterfall</h5>
				<p class="card-text">
					Lawpita waterfall and hydropower plant is located about 12 km’s to the east of Loikaw. It has beautiful scenery with the water cascading down the falls. Many fishes can clearly be seen in the beautiful, blue water. There is also a hydro power plant which supplies electrical power to different parts of the country. Permission is required for foreign visitors to visit Lawpita falls (through local tour operators).
				</p>
			</div>
		</div>
	</div>
