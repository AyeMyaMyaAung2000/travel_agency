			...
			<div class="col-md-9">
				...
				<div class="row">
					...
					<div class="col-md-12 col-lg-8">
						<div class="card-body">
							<h5 class="card-title font-weight-bold">Day 1:Mandalay-Bago</h5>
							<p class="card-text">
								Arrive at mandalay where you will be welcomed by your English speaking local tour guide and transferred to your hotel. After refreshment at hotel, enjoy a walk through downtown mandalay.Bago was formerly known as Pegu.Bago is one of the richest archaeological sites in Myanmar. Apparently Mons were the first to settle at this site. Bago was made the capital of the Mon Kingdom and it came to be known as Hansavati(Hanthawaddy). It was also the seaport of ancient Mon kings.Then itbecame the Second Myanmar Empire founded by KingBayinnaung. 
							</p>
						</div>
					</div>
