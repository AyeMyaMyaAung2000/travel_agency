...
<div class="container packtitle">
	<h4 class="font-weight-bold">Monywa Trip</h4>
	<div class="container">
		<div class="row">
				...
				<div class="row">
					...
					<div class="col-md-12 col-lg-4">
						...
						<div class="row">
							...
							<div class="col-md-12 col-lg-8">
								<div class="card-body">
									<h5 class="card-title font-weight-bold">Day 2:Monywa
									</h5>
									<p class="card-text">
										After breakfast, move on the route to Monywa. On arrival, visit the Thanbuddhay pagoda, then head up to the picturesque Bodi Tataung where the gigantic reclining Buddha and standing Buddha are located. Proceed to the fascinating caves of Po Win Taung. Late afternoon stroll around the city center. Overnight at hotel in Monywa.
									</p>
								</div>
							</div>
							<div class="col-md-12 col-lg-4">
						...
						<div class="row">
							...
							<div class="col-md-12 col-lg-8">
								<div class="card-body">
									<h5 class="card-title font-weight-bold">Day 3:Monywa-Alaung Taw Khathapa</h5>
