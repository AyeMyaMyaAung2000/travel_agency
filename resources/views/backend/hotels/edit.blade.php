	...
	<div class="text-justify py-2">
		...
		<form method="POST" action="{{ route('hotels.update',$hotel->id)}}" enctype="multipart/form-data">
			...
			<div class="row">
				...
				<div class="col-lg-7"><input type="text" name="name" class=" form-control my-2"  value="{{$hotel->name}}">
					@error('name')
				...
				<div class="col-lg-7"><img src="{{asset($hotel->photo)}}" width="50px;">
				<input type="file" name="photo" class="form-control-file my-2" >
				<input type="hidden" name="oldphoto" value="{{$hotel->photo}}"></div>

				<div class="col-lg-5" style="padding-left: 200px">Price:</div>
				<div class="col-lg-7"><input type="text" name="price" class=" form-control my-2"  value="{{$hotel->price}}">
					@error('name')
					<p class="text-danger">Your name is required</p>
					@enderror
